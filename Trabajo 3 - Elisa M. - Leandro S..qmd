...
A partir de los resultados arrojados por la tabla de regresiones, se puede apreciar que en el modelo 1, que el coeficiente de frecuencia de consumo de alcohol es 0.01, lo que quiere decir que por cada unidad de frecuencia en el consumo de alcohol, la preocupación aumenta 0.01 unidades. No obstante, esta coeficiente no es estadísticamente significativo.

En el modelo 2, se utilizó el coeficiente de sexo, tomando como referencia el grupo de los hombres. El coeficiente que arroja ese modelo es de 0.34, lo que traduce que el hecho de ser mujer aumenta 0.34 unidades en preocupación. Este efecto lo podemos extrapolar a la población con un 99.9% de confianza.
