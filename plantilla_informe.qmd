...
base <- read_dta("input/BBDD_Respuesta_Encuesta_Jovenes.dta") 
```
...
-   frecuencia de consumo de alcohol: cada cuánto consumen alcohol los/as entrevistados/as, con nivel de medición
